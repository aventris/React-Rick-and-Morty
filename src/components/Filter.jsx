...
const Filter = ({ handleGender, handleStatus, status, gender }) => {
  ...
  return (
    <>
      <div className='filter' onMouseEnter={handleToggleFilter} onMouseLeave={handleToggleFilter}>
        <div className='filter__button' >
          <span className='filter__title'>Filter</span>
          <img className='filter__icon' src={!toggleFilter ? arrowDown : arrowUp} alt="" />
        </div>
        {toggleFilter &&
          <div className='filter__wrapper'>
            ...
            <div className='filter__line'>
              <input type="radio"
                ...
                {...status === '' ? { defaultChecked: true } : null}
              />
